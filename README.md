...
[13. Тестирование приложения](#title13) /
[14. Установка проекта](#title14) / 
[15. Получение ключей .env](#title15) / 
[16. Описание файла .flake8](#title16) / 
[17. Описание файла mypy.ini](#title17) / 
[18. Описание файла .coveragerc](#title18) / 
...
# <a id="title13">13. Тестирование приложения</a>
...
# <a id="title14">14. Установка проекта</a>
...
# <a id="title18">18. Описание файла .coveragerc</a> 
```ini
